...
const LanguageSwitcher: React.FC<LanguageSwitcherProps> = ({
  ...
  const isCs = selectedLang === "cs";

  return (
    <div className="language-switcher">
      <button className="lang-button" onClick={handleClick}>
        <div className={`lang-flip ${isCs ? "" : "lang-flip--flipped"}`}>
          <img src={CSflag} className="lang-face lang-face--front" alt="čeština"/>
          <img src={ENflag} className="lang-face lang-face--back" alt="angličtina"/>
        </div>
      </button>
    </div>
  );
